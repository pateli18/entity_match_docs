...
You can use `AugerData` in three ways:
* **API** - for developers who want to integrate AugerData into their applications
* **Application** - for users who want to use AugerData without writing code
* **Google Sheets** - for users who want to use AugerData within their existing data workflows
