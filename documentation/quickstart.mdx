...
* [Match](/documents/match/overview) enables you to automatically determine if two entities (people, businesses, products, places, etc.) are the same
* [Transform](/documents/transform/overview) enables you to automatically extract and format multiple values from your data records
* [Categorize](/documents/categorize/overview) enables you to automatically tag and bucket your data records for easier organization
